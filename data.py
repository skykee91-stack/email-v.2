...
KEYWORD_GROUPS = {
    ...
    # 골프 관련: 카테고리명 단독 검색 시 0건 케이스 → 변형으로 우회
    "스크린골프": ["스크린골프장", "골프존", "스크린골프", "실내골프"],
    "골프연습장": ["실내골프연습장", "골프연습장", "골프스튜디오", "골프아카데미"],
    "크로스핏": ["크로스핏박스", "크로스핏", "크로스핏짐"],
    "피트니스": ["피트니스", "피트니스센터", "헬스장", "PT샵"],
    "축구장": ["풋살장", "실내축구장", "축구장", "풋살클럽"],

    # 병원·의료
    "치과": ["치과", "치과의원", "임플란트치과", "교정치과", "치아교정"],
    "병원": ["병원", "의원", "종합병원", "내과", "외과"],
    # 한의원: 단독 검색 시 searchIframe 못 찾는 케이스 발견 → 잘 되는 한방병원을 먼저 시도
    "한의원": ["한방병원", "한방클리닉", "한의원", "한의"],
    "동물병원": ["동물병원", "동물의료센터", "펫클리닉", "수의과"],
    "성형외과": ["성형외과", "성형외과의원", "미용성형", "성형클리닉"],
    # 산부인과/통증의학과 등: 카테고리명 그대로 검색 시 0건 → 변형으로 우회
    "산부인과": ["산부인과의원", "여성의원", "산부인과", "여성병원"],
    "통증의학과": ["통증클리닉", "통증의학과의원", "통증의학과", "통증센터"],
    "비뇨기과": ["비뇨기과의원", "비뇨의학과", "비뇨기과", "남성의원"],
    "신경외과": ["신경외과의원", "신경외과", "척추신경외과"],
    "재활의학과": ["재활의학과의원", "재활의학과", "재활클리닉"],
    "정신건강의학과": ["정신건강의학과의원", "정신과", "정신건강의학과", "심리상담"],
    "안과": ["안과의원", "안과병원", "안과", "라식수술"],
    "정형외과": ["정형외과의원", "정형외과", "관절전문병원", "관절외과"],
    "한방병원": ["한방병원", "한방클리닉", "한의원", "한의"],
    ...
    # 단독 검색 시 0건 → 변형으로 우회
    "샷시": ["창호", "샷시", "샷시업체", "ALC샷시", "윈도우샷시"],
    "방충망": ["방충망설치", "방충망", "방충망교체", "롤방충망"],
    "파고라": ["파고라설치", "파고라", "조경시설", "정자"],
